"""
Шеснадцатиричные нечетные числа, не превышающие 4096 и содержащие количество цифр равное сумме первой и последней цифр. Вывести числа и их количество.
...
with open('input.txt', 'r') as f: 
    while True: 
        ...
        # 16-ые нечетные числа, не превышающие 4096 
        for match in re.findall(r'\b[0-9a-fA-F]{0,2}[13579BDF]\b|\b1000\b', block): 
            num = convert_to_decimal(match) 
            if len(str(num)) == (int(str(num)[0]) + num % 10): 
                nums_10.append(num) 
