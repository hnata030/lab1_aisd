"""
Шеснадцатиричные четные числа, не превышающие 204810 и содержащие
количество цифр равное первой цифре. Вывести числа и их количество.
...
c = []
with open('posl.txt', mode='r') as f:
    a = f.read(buffer_len)
    if not a:
